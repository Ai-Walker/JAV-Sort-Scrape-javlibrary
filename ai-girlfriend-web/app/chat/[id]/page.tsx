      ...
      <div className="flex-1 flex flex-col relative z-10">
        ...
        <header className="px-6 py-4 bg-slate-950/80 backdrop-blur-xl border-b border-slate-800 flex items-center justify-between sticky top-0 z-20">
            <div className="flex items-center gap-4">
                <Link href="/discovery" aria-label="返回" className="md:hidden text-slate-400 hover:text-white transition-colors">
                    <ArrowLeft size={24} />
                </Link>
            ...
            <div className="flex gap-4 text-slate-400">
                 ...
                 <button aria-label="更多功能" className="hover:text-white transition-colors"><Sparkles size={20} /></button>
                 <button aria-label="選項" className="hover:text-white transition-colors"><MoreVertical size={20} /></button>
            </div>
        </header>
        ...
        <div className="p-4 bg-slate-950 border-t border-slate-800">
            <div className="max-w-4xl mx-auto flex items-end gap-3 bg-slate-900 p-2 rounded-2xl border border-slate-800 focus-within:border-pink-500/50 focus-within:ring-1 focus-within:ring-pink-500/20 transition-all shadow-lg">
                <button aria-label="上傳圖片" className="p-3 text-slate-400 hover:text-pink-400 transition-colors rounded-xl hover:bg-slate-800">
                    <ImageIcon size={20} />
                </button>
                <textarea
                    value={input}
                    ...
                    rows={1}
                />
                <button aria-label="語音輸入" className="p-3 text-slate-400 hover:text-pink-400 transition-colors rounded-xl hover:bg-slate-800 md:hidden">
                    <Mic size={20} />
                </button>
                <button
